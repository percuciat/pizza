...
const Cart = () => {
    ...
    const pizzasData = Object.keys(items).map(key => {
                    ...
                    <div className="cart">
                        <div className="cart__top">
                            ...
                            <div className="cart__clear">
                                ...
                                <button onClick={resetCart}>Очистить корзину</button>
                            </div>
                        </div>
                        <div className="content__items">
                            {
                                pizzasData.map(elem => {
                                    return  <CartItem   key={elem.id}
                                                       dataElem={elem}
                                                      priceTotal={items[elem.id].totalPrice}
